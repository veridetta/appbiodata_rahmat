...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String row_blog = "Alamat";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + table_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nomor + " TEXT, " + row_nama + " TEXT, " + row_kelas + " TEXT, "
                + row_tempatLahir + " TEXT, " + row_tglLahir + " TEXT, " + row_blog + " TEXT, " + row_foto + " TEXT)";
        db.execSQL(query);
    }
